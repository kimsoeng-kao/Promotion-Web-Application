...
<header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="/" class="scrollto">AllInOne</a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="{{ url('/foodAndDrink') }}">Food & Drink</a></li>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>AllInOne</strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- #footer -->
